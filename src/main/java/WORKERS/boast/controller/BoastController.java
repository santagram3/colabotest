...
public class BoastController {
	...
	@PostMapping("/add")
	public String addBoast(@ModelAttribute Boast boast ,@ModelAttribute BoastImg boastImg ,@RequestParam("file") MultipartFile file )throws Exception  {
		...
		System.out.println("11");
			...
			System.out.println(boastImg.toString());
