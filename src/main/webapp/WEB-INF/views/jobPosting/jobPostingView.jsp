...
<!--                 구인공고    jobPostingView               -->
    ...
    <a href="/jobs/list" class="btn btn-primary">돌아가기</a> 
    <a href="/jobs/modify/${jobs.cno}" class="btn btn-primary">수정하기</a>
    <a href="/jobs/delete/${jobs.cno}" class="btn btn-primary">삭제하기</a>
