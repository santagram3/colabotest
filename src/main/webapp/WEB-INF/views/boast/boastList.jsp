    ...
    <div class="container">
        <table class="table caption-top border border-light">
            ...
            <div class="d-flex flex-row-reverse flex-wrap">
                <div class="bottom mt-3">
                    <p class="fs-6 p-1">목록 보여주기 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="bottom-left">
                        <select id="cntSelectBox" name="cntSelectBox"
                            ...
                            <option value="10" <c:if test="${pagination.cntPerPage == '10'}">selected</c:if>>10개씩
                            </option>
                            <option value="20" <c:if test="${pagination.cntPerPage == '20'}">selected</c:if>>20개씩
                            </option>
                            <option value="30" <c:if test="${pagination.cntPerPage == '30'}">selected</c:if>>30개씩
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <thead>
                <tr class="fw-bold">
                    ...
                    <th scope="col">제목</th>
                    <th scope="col">작성자</th>
                    <th scope="col">작성일 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <c:when test="${fn:length(AllList) > 0}">
                        <c:forEach items="${AllList}" var="list" varStatus="status">
                            <tr>
                                ...
                                <td><a href="delete/${list.BNOSP}"><span
                                            class="badge bg-secondary btn-sm">&times;</span></a></td>
                            </tr>
                        </c:forEach>
                    </c:when>
                    <c:otherwise>
        ...
        <div class="paginate text-center">
            <div class="paging p-2">
                ...
                <a class="direction prev text-muted" href="javascript:void(0);"
                    onclick="movePage(${pagination.currentPage}<c:if test=" ${pagination.hasPreviousPage==true}">-1
                    </c:if>,${pagination.cntPerPage},${pagination.pageSize});">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
