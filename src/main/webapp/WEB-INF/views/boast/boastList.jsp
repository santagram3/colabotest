...
<%@ include file ="../header/header.jsp" %>
   ...
   <body>
   <div class="container w-75 mt-5 mx-auto d-flex p-2">
   <img src="/resources/boast/boastL2.png">
	<button class="btn btn btn-dark mb-3" type="button" 
	        data-bs-toggle="collapse" 
	        data-bs-target="#addForm" 
	        aria-expanded="false" 
	        aria-controls="addForm">공부 자랑하기 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
