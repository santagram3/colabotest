...
<%@ include file ="../header/header.jsp" %>
   ...
   <div class="container w-75 mt-5 mx-auto ">
   	<a href="/boast/addForm" type="button" class="btn btn-info fw-bold fs-5 mt-3">
   <img src="/resources/boast/boast2.png"></a>
   </div>
   <div class="container w-75 mt-5 mx-auto">
   <hr>
...
<br><br>			
	...
	<div class="container">	 
  	<p class="fw-bold fs-5">공부 자랑하기</p>  
  		<a href="/boast/addForm" type="button" class="btn btn-dark fw-bold ">작성하기<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
