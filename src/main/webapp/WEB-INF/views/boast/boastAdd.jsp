...
<head>
    ...
    <!-- <link rel="stylesheet" href="/resources/boast/boastList.css">
...
<img src="/resources/boast/img/add.png" class="img-fluid" alt="...">
	<div class="shadow p-3 mb-5 bg-body rounded card border-primary position-absolute top-100 start-50 translate-middle " style="width:800px;">
		<form  method="post" action="/boast/add" enctype="multipart/form-data">
		...
		<div class="card-body">
	 	...
	 	<div id = "boardForm">
				...
				<div class="mb-4">
  				<label class="form-label">글 작성자</label>
  				<input type="text" class="form-control" name="bWriter">
				</div>
				
				<div class="mb-4">
  				<label class="form-label">글 내용</label>
  				<input type="text" class="form-control" name="bContent">
				</div>
